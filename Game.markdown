...
- 游戏制式：
	- 在60s 或者 血量扣完游戏结束之前 通过抓取不同的精灵来获得经验，并且精灵的收集，可以激活**彩蛋**；点击则会使玩家回到虚拟场景模式，关闭通往显示世界的通道；
...
#### 可玩性和玩家黏性
本游戏的背景和故事的主线较为新颖，比较符合当代年轻人的兴趣点。并以玩游戏的方式将招商银行，消费者和商家结合在一起，消费者不仅可以在游戏中找到乐趣，而且在乐趣中可以获得一定的实惠。这样消费者容易接受并且将其介绍给朋友一起游戏。
...
#### 真实场景下的可行性分析
在真实场景下，客户端主要涉及到：  
1. 手机的定位；2. 摄像头的调用，他们分别可以采用`HTML5 Geolocation`和`****`来实现。
根据中国游戏产业年会上发布的《2015年中国游戏产业报告》，这一年国内游戏市场规模高达1407亿，其中网页游戏占15.6%，约为移动游戏的50%。而据DataEye2015年发布的HTML5游戏数据报告，在网页游戏中HTML5游戏占比并不高，且付费率较低。尽管HTML5游戏具备无需下载、包含社交属性、开发成本低等优势，但如果没有充分利用HTML5的新特性，加强移动游戏的交互能力，它很难在游戏市场中异军突起。由此，网页游戏未来更有可能结合HTML5优良的特性。
